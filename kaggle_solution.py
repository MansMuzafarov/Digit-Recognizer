...
from config import train_model_kaggle, alpha, number_of_epochs, batch_size
...
def make_predictions_for_kaggle():
    ...
    if train_model_kaggle or not os.path.exists(model_path):
    ...
    if train_model_kaggle and loss_history:
